...
Current dashboard proof shows the core service monitors up, including a dedicated AdGuard DNS monitor. Phase 4 monitoring and alerting proof is complete.
...
- AdGuard Home is running, and one-device DNS filtering proof is complete.
...
- Router-wide DNS remains deferred until a future rollout decision.
